        ...
        <div className="min-w-[1000px] max-w-[1500px] m-auto p-4">
          <div className="grid grid-cols-10 gap-2">
            ...
            <div className="col-span-5 p-4 rounded bg-white divide-y divide-gray-400">
              ...
              <div className="text-base xl:text-l mt-3">
                {product.description}
              </div>
            </div>
            ...
            <div className="col-span-2 p-4 rounded bg-white">
              <div className="text-xl xl:text-2xl font-semibold text-red-600 text-right">
              ...
              <div className="text-base xl:text-lg font-semibold text-green-600 mt-1">
                In Stock
              </div>
              ...
              <div className="text-base xl:text-lg mt-1">
                ...
                <select
                  ...
                  className="p-2 bg-white border-2 rounded-md focus:border-indigo-500"
                >
                  <option>1</option>
                  <option>2</option>
                  <option>3</option>
